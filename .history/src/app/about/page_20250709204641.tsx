...
export default function AboutPage() {
    ...
    const containerVariants = {
        hidden: { opacity: 0 }, // Kontainer bisa langsung terlihat
        visible: {
            opacity: 1,
            transition: {
                // Tugasnya HANYA untuk mengatur jeda antar anak
                staggerChildren: 0.03, // Anda bisa sesuaikan jedanya
            }
        }
    } as const;
    ...
    const itemVariants = {
        hidden: { y: 100, opacity: 0 }, // Posisi awal anak
    ...
    return (
        <div className="px-40 py-20 w-full ">
            ...
            <div className="w-full px-4 md:px-8 lg:px-16 mt-20 mb-20">
                <motion.div variants={containerVariants} initial="hidden" animate="visible" transition={{ type: 'tween' }} className="flex flex-col md:flex-row justify-center items-stretch gap-8">
