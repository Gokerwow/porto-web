    ...
    return (
        <div className="px-40 py-20 w-full ">
            ...
            <div className="w-full px-4 md:px-8 lg:px-16 mt-20 mb-20">
                <motion.div variants={containerVariants} initial="hidden" animate="visible" transition={{ type: 'tween', duration: 10 }} className="flex flex-col md:flex-row justify-center items-stretch gap-8">
