...
import { cubicBezier, Easing, motion, useMotionValue, useTransform } from "framer-motion";
...
export default function AboutPage() {
    ...
    return (
        <div className="px-40 py-20 w-full ">
            <motion.div initial={{ y: 48, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ ease: 'easeInOut', duration: 0.5 }} className="w-full flex items-center bg-red-300">
