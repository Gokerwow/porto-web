...
export default function AboutPage() {
    ...
    const containerVariants = {
        ...
        visible: {
            ...
            transition: {
                type: 'spring',
                staggerChildren: 0.3 // Atur jeda antara setiap kartu
            }
        }
    } as const;
    ...
    return (
        <div className="px-40 py-20 w-full ">
            ...
            <div className="w-full px-4 md:px-8 lg:px-16 mt-20 mb-20">
                <motion.div variants={containerVariants} initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 100 }} transition={{ type: 'spring', staggerChildren: 0.5 }} className="flex flex-col md:flex-row justify-center items-stretch gap-8">
