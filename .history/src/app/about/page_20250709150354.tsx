    ...
    return (
        <div className="px-40 py-20 w-full ">
            <motion.div initial={{ y: 48, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ ease: 'easeInOut', duration: 0.5 }} className="w-full flex items-center">
                ...
                <div className="w-1/2">
                    <p>Brillian Maulana Syah, an Indonesian-based creative developer and emerging software engineer with a passion for the front-end. I thrive on transforming ideas into elegant and interactive digital solutions. My project experience includes developing immersive, animated websites, scalable applications, and robust design systems. I am driven by the challenge of using code to build meaningful and innovative products.</p>
                </div>
            </motion.div>
