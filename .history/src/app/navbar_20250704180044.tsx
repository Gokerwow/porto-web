...
export default function Navbar() {
    ...
    const radius = isOpen ? 60 : 0; // Terbuka: 60px, Tertutup: 0px
            ...
            >
                ...
                <Link 
                    ...
                    style={{ 
                        ...
                        opacity: opacity,
                        transform: `rotate(0deg) translate(${radius}px) rotate(0deg) scale(${isOpen ? 2 : 0})`,
                ...
                <Link 
                    ...
                    style={{ 
                        opacity: opacity,
                        transform: `rotate(90deg) translate(${radius}px) rotate(-90deg) scale(${isOpen ? 1 : 0})`,
                ...
                {/* Anda bisa menambahkan link lain di sini dengan mengubah 'rotate()' */}
                <Link 
                    href="/skills" 
                    className="absolute top-1/2 left-1/2 -mt-6 -ml-6 w-12 h-12 rounded-full bg-white border-2 border-black flex items-center justify-center transition-all duration-300 ease-in-out hover:scale-110"
                    style={{ 
                        opacity: opacity,
                        transform: `rotate(180deg) translate(${radius}px) rotate(-180deg) scale(${isOpen ? 1 : 0})`,
                        pointerEvents: isOpen ? 'auto' : 'none'
                    }}
                >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l4 4m0 0l4 4m-4-4L11 9m10 10l-4-4m0 0l-4-4m4 4l-4 4"></path></svg>
                </Link>
