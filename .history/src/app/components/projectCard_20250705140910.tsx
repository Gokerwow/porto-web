...
export function ProjectCard({ title, description, media, tags, year, accent, index }: ProjectCardProps) {
    return (
        <div
            className="group hover:scale-[1.015] transition-all duration-500 bg-gray-500"
            style={{
                transformStyle: "preserve-3d"
            }}
        >
            <div className="relative inset-4 h-full transform transition-all duration-700 bg-white">
                {/* Kartu Glassmorphism dengan 'transform-style' yang sudah diperbaiki */}
                <div
