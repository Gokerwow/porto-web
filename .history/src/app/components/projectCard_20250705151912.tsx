...
export default function ProjectCard({ title, description, media, tags, year, accent, index }: ProjectCardProps) {
    return (
        <div
            key={index}
            className=" transform-3d rotateY-90 hover:scale-[1.015] transition-all duration-500 bg-black translate-z-20 perspective-1000 group relative h-full w-full max-w-md mx-auto shadow-lg hover:shadow-xl rounded-2xl overflow-hidden"
        >
