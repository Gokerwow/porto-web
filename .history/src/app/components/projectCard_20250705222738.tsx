...
{/* Gunakan div dengan flexbox sebagai pembungkus baru */}
<div className={`relative z-10 flex items-center font-medium text-sm bg-gradient-to-r ${accent} bg-clip-text text-transparent cursor-pointer`}>
    
    {/* Teks sekarang berada di dalam span-nya sendiri */}
    <span>View Project Details</span>
    
    {/* Panah sekarang menjadi saudaranya, bukan anaknya */}
