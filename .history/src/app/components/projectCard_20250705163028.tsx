...
export default function ProjectCard({ title, description, media, tags, year, accent, index }: ProjectCardProps) {
    return (
        <div className="w-full h-[450px] bg-gray-300 inset-0 rounded-lg shadow-xl relative group transform-3d rotate-x-45">
            <div className="absolute inset-4 h-full rounded-xl bg-white shadow-lg transform-3d translate-z-[75px] ">
