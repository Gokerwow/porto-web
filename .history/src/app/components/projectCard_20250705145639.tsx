...
export default function ProjectCard({ title, description, media, tags, year, accent, index }: ProjectCardProps) {
    return (
        ...
        >
            <div className="relative h-full transform transform-3d transition-all rounded-2xl bg-white duration-700 group-hover:rotate-x-[3deg] group-hover:rotate-y-[3deg] translate-z-20">
                {/* Glassmorphism card */}
