...
export default function ProjectCard({ title, description, media, tags, year, accent, index }: ProjectCardProps) {
    return (
        <div
            key={index}
            className=" transform-3d rotateY-90 hover:scale-[1.015] transition-all duration-500 bg-black"
        >
            <div className="relative h-full transform transform-3d transition-all duration-700 group-hover:rotate-x-[3deg] group-hover:rotate-y-[3deg] translate-z-10">
                {/* Glassmorphism card */}
