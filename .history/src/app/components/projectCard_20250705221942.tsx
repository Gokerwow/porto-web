                ...
                <div className="absolute inset-4 rounded-xl bg-white shadow-lg transform-3d translate-z-[75px]">
                    ...
                    <div className="p-6 transform-3d translate-z-[50px]">
                        ...
                        <div className="flex justify-between items-center">
                            <span
                                className={`
    relative z-10 px-0 py-1 font-medium text-sm 
    bg-gradient-to-r ${accent} bg-clip-text text-transparent 
    group-hover:brightness-110 transition-all cursor-pointer
    overflow-hidden
    before:content-[''] before:absolute before:left-0 before:-bottom-0.5 before:w-0 before:h-0.5 
    before:bg-gradient-to-r ${accent} before:transition-all before:duration-300
    group:hover:before:w-full
    after:content-['_→'] after:ml-1 after:opacity-0 after:transition-all after:duration-200
    group:hover:after:opacity-100 hover:after:translate-x-1
  `}
                            >
