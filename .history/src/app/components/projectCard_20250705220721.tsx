            ...
            <div className="absolute inset-4 rounded-xl bg-white shadow-lg transform-3d translate-z-[75px]">
                ...
                <div className="p-6 transform-3d translate-z-[50px]">
                    ...
                    <div className="flex justify-between items-center">
                        <Link href={`/projects/${index}`} className={`px-0 py-1 font-medium text-sm bg-gradient-to-r ${accent} bg-clip-text text-transparent group-hover:brightness-110 transition-all cursor-not-allowed`}>
