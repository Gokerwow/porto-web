    ...
    return (
        ...
        <div className="group" style={{ perspective: '1000px' }}> 
            ...
            */}
            ...
            <div
                key={index}
                className="transform-3d h-full w-full rounded-2xl transition-all duration-700 group-hover:transform group-hover:rotate-x-[3deg] group-hover:rotate-y-[6deg] group-hover:scale-[1.03]"
            >
