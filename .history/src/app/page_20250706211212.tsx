    ...
    <div className="relative flex-1">
      ...
      <div className=" w-full flex justify-center items-end h-full">
        <div className="absolute z-20 right-1/2 top-1/2 ">
          <h1 className={`text-7xl p-7 bg-amber-300 ${Transcity.className}`}>Brillian Maulana <br /> Syah</h1>
          <svg className="absolute inset-0" width="700" height="350" viewBox="0 0 1126 550" fill="none" xmlns="http://www.w3.org/2000/svg">
