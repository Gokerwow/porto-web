    ...
    <div className="relative h-screen overflow-hidden">
      <div className='pt-5 flex justify-between px-7'>
        ...
        <div className="text-right flex flex-col relative z-30">
          <Link href={'https://github.com/Gokerwow'} target="_blank" className={`text-xl text-gray-500 ${FiraCode.className}`}>GITHUB</Link>
          <Link href={'https://www.instagram.com/brilsyah.m/'} target="_blank" className={`text-xl text-gray-500 ${FiraCode.className}`}>INSTAGRAM</Link>
          <Link href={'https://www.youtube.com/@Goker_952/shorts'} target="_blank" className={`text-xl text-gray-500 ${FiraCode.className}`}>YOUTUBE</Link>
        </div>
      </div>

      <div className="absolute">
        <h1 className={`${Delirium.className} text-[930px] text-gray-300 leading-none text-center cursor-none`}>BRILLIANTS</h1>
      </div>

      <div className=" w-full flex justify-center items-end h-full">
        <div className="absolute z-20 left-1/6 top-1/3 ">
          <h1 className={`text-8xl p-7 text-right cursor-none  ${Transcity.className}`}>Brillian <br /> Maulana  Syah</h1>
        </div>
        <div className="absolute z-20 right-80 top-1/3 ">
          <h1 className={`text-3xl p-7 text-left cursor-none ${FiraCode.className} text-gray-700 `}>A <span className="text-black font-bold">Developer</span> who loves <br /> discovering new things and <br /> exploring the frontiers of <br /> technology</h1>
        </div>
        <div className="relative w-[800px] h-[1000px]"> {/* Saya beri contoh bingkai dengan tinggi dan lebar */}
          <Image
