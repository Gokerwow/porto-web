...
export default function Navbar() {
    return (
        <nav className="fixed flex flex-col justify-between p-4 w-[300px] h-screen ">
            <div>
                <h1 className='flex flex-col justify-center items-center font-bold pt-5'>BRILLIANTS</h1>
                <h3 className='flex flex-col justify-center items-center font-bold pt-5'>Full Stack <Developer></Developer></h3>
            </div>
