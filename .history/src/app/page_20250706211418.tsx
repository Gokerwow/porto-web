    ...
    <div className="relative flex-1">
      ...
      <div className=" w-full flex justify-center items-end h-full">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          {/* Jadikan div ini sebagai wadah 'relative' 
    agar SVG bisa diposisikan 'absolute' di dalamnya.
  */}
          <div className="relative">
            {/* Elemen h1 ini sekarang menjadi penentu ukuran. 
      SVG di bawah akan mengikuti ukurannya.
    */}
            <h1 className={`text-7xl p-7 bg-amber-300 ${Transcity.className}`}>
              Brillian Maulana <br /> Syah
            </h1>

            {/* SVG ini sekarang akan meregang 100% mengisi wadah 'relative'-nya.
      Atribut width dan height di sini tidak lagi diperlukan karena sudah diatur oleh Tailwind.
    */}
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1126 550" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
              <path d="M1121 545L819 293M819 293H21.5C12.6634 293 5.5 285.837 5.5 277V21.5C5.5 12.6635 12.6634 5.5 21.5 5.5H803C811.837 5.5 819 12.6634 819 21.5V293Z" stroke="white" strokeWidth="10" strokeLinecap="round" />
            </svg>
          </div>
        </div>
