        ...
        <div className="px-[300px] py-40 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="skill-card p-8 rounded-xl border border-gray-100 bg-white">
                    ...
                    technologies={["React", "Vue", "TypeScript", "Tailwind CSS", "Node.js", "Express", "PostgreSQL", "MongoDB", "Docker", "AWS", "CI/CD Pipelines"]}
                    />
                </div>
            </div>
        </div>
        ...
        <div className="skill-content">
            ...
            <ul className="space-y-4">
                <li className="flex items-start">
                    ...
                    <div>
                        <h3 className="font-medium text-gray-800">{skills[0]}</h3>
