            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-between">
                ...
                <div className="skill-card p-8 rounded-xl border border-gray-100 bg-white">
                    <SkillCard
                        title="Design"
                        skills={[
                            { name: "UI/UX", technologies: ["Figma"] },
                            { name: "Graphic Design", technologies: ["Adobe Photoshop", "Adobe Illustrator"] },
                            { name: "3D Modeling", technologies: ["Spline", "Blender"] }
                        ]}
                    />
                </div>
                <div className="skill-card p-8 rounded-xl border border-gray-100 bg-white">
                    <SkillCard
                        title="Editing"
                        skills={[
                            { name: "Video Production", technologies: ["Adobe Premiere Pro, Adobe After Effects"] },
                            { name: "Photo & Image Manipulation", technologies: ["Adobe Photoshop"] },
                            { name: "Audio Production", technologies: ["Audacity"] }
                        ]}
                    />
                </div>
            </div>
                    ...
                    return (
                        <li key={skill.name} className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm mt-1">{skill.technologies.join(", ")}</p>
                            </div>
                        </li>
                    )
                })}
