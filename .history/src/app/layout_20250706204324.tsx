      ...
      >
        <main className="h-screen flex flex-col"> {/* <--- TAMBAHKAN INI */}
          <div className='pt-5 flex justify-between px-7'>
            <div>
              <h1 className={`flex flex-col justify-center items-center text-xl ${FiraCode.className}`}>Based In</h1>
              <h3 className={`flex flex-col justify-center items-center italic text-[#ffffff2e] ${FiraCode.className}`}>INDONESIA</h3>
            </div>
            <div>
