                            ...
                            <div key={link.href} className="relative flex flex-col items-center group">
                                <Link href={link.href}>
                                    {React.cloneElement(link.icon, {
                                        className: `h-12 w-12 p-2 rounded-xl transition-all duration-300 ${
                                            isActive 
                                ...
                                <span className="absolute bottom-full mb-2 px-3 py-1 text-sm font-semibold text-white bg-[#282a36] rounded-md 
