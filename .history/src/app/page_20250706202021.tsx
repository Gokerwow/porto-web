...
export default function Home() {
  ...
  return (
    <div className="relative h-full">
      ...
      <div className="h-screen w-full bg-amber-500 flex justify-center items-end">
        <div className="relative w-[500px] h-[500px] border-4 border-white"> {/* Saya beri contoh bingkai dengan tinggi dan lebar */}
          <Image
