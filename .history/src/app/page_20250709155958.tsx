  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <motion.div initial="initial" animate="animate" className="absolute">
        <motion.div variants={{ initial: { y: 100 }, animate: { y: 0} }}  transition={{ type: 'tween', duration: 2, ease: "easeIn" }}>
          <h1 className={`${Delirium.className} text-[730px] text-gray-300 leading-none text-center cursor-default`}>BRILLIANTS</h1>
        </motion.div>
      </motion.div>
