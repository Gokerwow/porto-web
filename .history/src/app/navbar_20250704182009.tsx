...
import { usePathname } from 'next/navigation'; // Langkah 2: Impor dari next/navigation

export default function Navbar() {
    const pathname = usePathname(); // Langkah 3: Gunakan usePathname

    return (
        <div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-50">
            <div className="flex flex-col gap-2 p-2 bg-yellow-400 rounded-l-lg shadow-xl">
                
                {/* Ganti semua `router.pathname` menjadi `pathname` */}
