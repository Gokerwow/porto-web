        ...
        <div className="min-h-screen overflow-hidden relative bg-gray-100">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="text-gray-200 font-bold text-[20rem] md:text-[25rem] leading-none select-none opacity-40 tracking-tighter">
                        PROJECTS
                    </div>
                </div>
            ...
            {/* Location indicator like "Based in Jember, Indonesia" */}
            ...
            {/* Social links area (right side) */}
            <div className="fixed top-8 right-8 z-20">
                <div className="text-sm text-gray-600 font-medium text-right space-y-1">
