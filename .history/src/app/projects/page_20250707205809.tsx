...
export default function Projects() {
    ...
    return (
        <div className="min-h-screen overflow-hidden relative">
            ...
            {/* Projects Grid */}
            <motion.div initial={{ y: 100, opacity:0 }} animate={{ y:0, opacity:1 }} transition={{ type:"tween", ease:"backOut", duration:1.5, staggerDirection: 2 }} className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 px-8 pb-20 max-w-6xl mx-auto">
