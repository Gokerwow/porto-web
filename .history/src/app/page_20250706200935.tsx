  ...
  return (
    <div className="relative">
      <div className="absolute">
        <h1 className={`${Delirium.className} text-[930px] leading-none text-center`}>BRILLIANTS</h1>
      </div>
      <div className="relative z-10 h-screen flex justify-center pt-30 bg-amber-700">
        <Image
          src={"/assets/foto_pribadi_3.png"}
          alt={"foto"}
          fill // Hapus width dan height, ganti dengan fill
          className="object-cover object-top" // Tambahkan ini untuk menjaga rasio
        />
      </div>
    </div>
  )
