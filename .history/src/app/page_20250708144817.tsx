  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className=" w-full flex justify-center items-end h-full">
        ...
        <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ ease: "backOut", type: "tween", duration: 2 }} className="relative w-[600px] h-[900px]"> {/* Saya beri contoh bingkai dengan tinggi dan lebar */}
          <Image
