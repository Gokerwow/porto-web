    ...
    <div className="relative flex-1">
      ...
      <div className=" w-full flex justify-center items-end h-full">
        ...
        <div className="absolute z-20 right-1/8 top-1/3 ">
          <h1 className={`text-xl p-7 text-right ${FiraCode.className} text-gray-700 `}>A <span className="text-black">Developer</span> who loves <br /> discovering new things</h1>
        </div>
