  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className=" w-full flex justify-center items-end h-full relative">
        ...
        <div className="absolute z-20 right-50 top-1/5 ">
          <motion.h1 initial={{ opacity:0 }} animate={{ opacity:1 }} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={`text-3xl p-7 text-left ${FiraCode.className} text-gray-700 `}>A <span className="text-black font-bold">Developer</span> who loves <br /> discovering new things and <br /> exploring the frontiers of <br /> technology</motion.h1>
        </div>
