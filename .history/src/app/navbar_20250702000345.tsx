...
export default function Navbar() {
    ...
    <nav className="fixed flex flex-col justify-between p-4 w-[100px] h-screen bg-red-400">        
        <ul className="nav-links flex flex-col justify-center items-center gap-10 bg-blue-400 flex-1">
            ...
            <li>
                <Link href="#" aria-label="Features" title="Features">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <li>
                <Link href="#" aria-label="Products" title="Products">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <li>
                <Link href="#" aria-label="About" title="About">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <li>
                <Link href="#" aria-label="Contact" title="Contact">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
