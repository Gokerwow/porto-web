    ...
    <div className="relative h-screen overflow-hidden">
      <div className='pt-5 flex justify-between px-7'>
        ...
        <div className="text-right flex flex-col">
          <Link href={'https://github.com/Gokerwow'} tabIndex={} className={`text-xl text-gray-500 ${FiraCode.className}`}>GITHUB</Link>
          <Link href={'https://www.instagram.com/brilsyah.m/'} className={`text-xl text-gray-500 ${FiraCode.className}`}>INSTAGRAM</Link>
          <Link href={'https://www.youtube.com/@Goker_952/shorts'} className={`text-xl text-gray-500 ${FiraCode.className}`}>YOUTUBE</Link>
        </div>
      </div>
