    ...
    return (
        ...
        >
            ...
            <div className="w-full flex justify-center items-end h-full relative">
                ...
                <div className="absolute z-20 left-1/2 -translate-x-1/2 top-1/4">
                    <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'tween', ease: 'easeIn', duration: 1, delay: 0.5 }} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={`text-3xl p-7 text-left ${FiraCode.className} text-gray-700`}>A <span className="text-black font-bold">Developer</span> who loves <br /> discovering new things and <br /> exploring the frontiers of <br /> technology</motion.h1>
                </div>
