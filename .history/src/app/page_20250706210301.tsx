  ...
  return (
    <div className="relative flex-1">
      ...
      <div className=" w-full flex justify-center items-end h-full">
        <div className="absolute z-20 right-1/2 top-1/2 bg-amber-800">
            <div className="w-full max-w-2xl mx-auto bg-[#282c34] rounded-lg shadow-2xl overflow-hidden">
        <div className="p-3 bg-gray-700 flex items-center">
            ...
            <div className="flex-grow text-center text-sm text-gray-300 font-semibold">
                bash
            </div>
        </div>
        ...
        <div className="p-4 text-white text-sm">
            <div className="flex items-center">
                ...
                <p className="ml-2 flex-1 tracking-wider">Brillian Maulana Syah<span className="inline-block w-2 h-4 bg-green-400 ml-2 animate-pulse"></span></p>
            </div>
        </div>
    </div>
          <h1 className={`text-9xl ${Transcity.className}`}>Brillian Maulana Syah</h1>
        </div>
