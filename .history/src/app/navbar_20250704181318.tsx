...
export default function Navbar() {
    return (
        <nav className="fixed flex flex-col justify-between w-[300px] h-screen ">
            {/* <div className='pt-5'>
            ...
            <ul className="nav-links h-full flex justify-center items-center gap-3 flex-1">
                <li className=' h-full'>
                    <Link href="/" className="flex items-center gap-2 w-[50px] h-full bg-amber-500">
                ...
                {/* Projects Link */}
                <li className=' h-full'>
                    <Link href="/projects" className="flex items-center gap-2 w-[50px] h-full bg-amber-500">
