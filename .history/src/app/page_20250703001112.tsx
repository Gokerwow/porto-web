  ...
  return (
    <div className="px-[300px] py-40 w-full">
      ...
      <div className="w-full px-4 md:px-8 lg:px-16 mt-20">
        {/* Menggunakan flexbox dengan gap untuk spasi yang konsisten, dan responsif */}
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8">

          {/* Kartu 1: Universitas */}
          <div className="flex-1 flex flex-col items-center p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            <h1 className="text-xl font-semibold text-gray-500 mb-4">Student of</h1>
            <div className="flex flex-col items-center text-center">
              {/* Kontainer untuk membuat ukuran gambar konsisten */}
              ...
              <span className="text-lg font-medium text-gray-800">University of Jember</span>
            </div>
          </div>

          {/* Kartu 2: Jurusan & Fakultas */}
          <div className="flex-1 flex flex-col items-center p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            <h1 className="text-xl font-semibold text-gray-500 mb-4">Majoring in</h1>
            <div className="flex flex-col items-center text-center">
              <div className="h-28 w-28 flex items-center justify-center mb-4">
                <Image
                  src="/assets/fasilkom (2).png"
                  alt="Fakultas Ilmu Komputer"
                  width={100} // Ukuran disamakan untuk konsistensi visual
                  height={100}
                  className="object-contain"
                />
              </div>
              <span className="text-lg font-medium text-gray-800">Information Systems</span>
              <span className="text-md text-gray-600">Faculty of Computer Science</span>
            </div>
          </div>

          {/* Kartu 3: Organisasi */}
          <div className="flex-1 flex flex-col items-center p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            <h1 className="text-xl font-semibold text-gray-500 mb-4">Part of</h1>
            <div className="flex flex-col items-center text-center">
              <div className="h-28 w-28 flex items-center justify-center mb-4">
                <Image
                  src="/assets/HMSF.png"
              ...
              <span className="text-lg font-medium text-gray-800">Himpunan Mahasiswa<br />Sistem Informasi</span>
            </div>
          </div>
