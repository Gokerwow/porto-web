  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute">
        <h1 className={`${Delirium.className} text-[930px] text-gray-300 leading-none text-center cursor-default`}>BRILLIANTS</h1>
      </div>
      ...
      <div className=" w-full flex justify-center items-end h-full">
        ...
        <div className="absolute z-20 right-80 top-1/3 ">
          <h1 className={`text-3xl p-7 text-left ${FiraCode.className} text-gray-700 `}>A <span className="text-black font-bold">Developer</span> who loves <br /> discovering new things and <br /> exploring the frontiers of <br /> technology</h1>
        </div>
