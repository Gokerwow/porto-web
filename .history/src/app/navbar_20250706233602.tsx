                    ...
                    {navLinks.map((link) => {
                        ...
                        return (
                            ...
                            <div key={link.href} className="relative flex flex-col items-center group">
                                ...
                                <span className="absolute bottom-full mb-2 px-3 py-1 text-sm font-semibold text-white bg-[#282a36] rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                    {link.label}
                                </span>
                            </div>
                        );
