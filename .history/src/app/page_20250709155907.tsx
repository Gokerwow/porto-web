...
export default function Home() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <motion.div initial="initial" animate="animate" transition={{ type: 'tween', duration: 2, ease: "easeIn" }} className="absolute">
        <motion.div variants={{ initial: { y: 100 }, animate: { y: 0} }}>
