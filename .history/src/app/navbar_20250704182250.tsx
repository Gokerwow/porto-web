            ...
            <div className="absolute right-0 top-0 h-full w-20 bg-yellow-400">
                <ul className="h-full flex flex-col pointer-events-auto">
                    <li className="flex-1 hover:flex-grow-[2] transition-all duration-300">
                        <Link href="/" className="h-full w-full flex items-center justify-center bg-purple-500 hover:bg-purple-600">
                    ...
                    <li className="flex-1 hover:flex-grow-[2] transition-all duration-300">
                        <Link href="/projects" className="h-full w-full flex items-center justify-center bg-blue-500 hover:bg-blue-600">
