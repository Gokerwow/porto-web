...
export default function Home() {
  ...
  return (
    <div className="relative flex-1">
      ...
      <div className=" w-full bg-amber-500 flex justify-center items-end h-full">
        <div className="relative w-[500px] h-[800px] border-4 border-white"> {/* Saya beri contoh bingkai dengan tinggi dan lebar */}
          <Image
