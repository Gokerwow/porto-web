    ...
    <div className="relative flex-1">
      ...
      <div className=" w-full flex justify-center items-end h-full">
        <div className="absolute z-20 right-1/2 top-1/2 bg-amber-800">
          <svg width="1126" height="550" viewBox="0 0 1126 550" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1121 545L819 293M819 293H21.5C12.6634 293 5.5 285.837 5.5 277V21.5C5.5 12.6635 12.6634 5.5 21.5 5.5H803C811.837 5.5 819 12.6634 819 21.5V293Z" stroke="white" stroke-width="10" stroke-linecap="round" />
          </svg>
