...
export default function Home() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <motion.div initial="initial" whileHover="animate" className="absolute overflow-hidden bg-amber-600 wful">
        <motion.div className="" variants={{ initial: { y: 0 }, animate: { y: 200} }}>
