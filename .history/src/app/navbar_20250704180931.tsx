...
export default function Navbar() {
    return (
        <nav className="fixed flex flex-col justify-between p-4 w-[300px] h-screen ">
            ...
            <ul className="nav-links flex justify-center items-center gap-3 flex-1">
                <li>
                    <Link href="/" className="flex flex-col items-center gap-2 rotate-90 w-full bg-amber-500">
