...
// Daripada menempelkan kode SVG yang panjang di dalam array, 
// lebih bersih membuat komponen kecil untuk setiap ikon.
...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { href: "/projects", icon: <PackageIcon className="h-6 w-6" />, label: "Projects" },
        { href: "/profile", icon: <UserIcon className="h-6 w-6" />, label: "Profile" },
        { href: "/settings", icon: <SettingsIcon className="h-6 w-6" />, label: "Settings" },
    ];
