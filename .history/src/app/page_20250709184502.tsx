...
export default function Home() {
  ...
  const handleAnimationComplete = () => {
    ...
    setTimeout(() => setShowMainContent(true), 100); // Beri jeda sebelum konten muncul
  };
    ...
    <div className="w-full flex justify-center items-end h-full relative">
      ...
      <div className="absolute z-20 right-50 top-1/4">
        <motion.h1
          ...
          className={`text-3xl p-7 text-left ${FiraCode.className} text-gray-700`}
        >
          A <span className="text-black font-bold">Developer</span> who loves <br />
      ...
      <motion.div
        ...
        transition={{ ease: "backOut", type: "tween", duration: 2 }}
