    ...
    return (
        ...
        >
            ...
            <div className="relative w-48 h-48">
                ...
                <svg className="absolute inset-0 w-full h-full text-violet-500 animate-spin" viewBox="0 0 100 100">
                    <circle
                        cx="50"
                        cy="50"
                        r="40"
                ...
                <div className="absolute inset-0 flex items-center justify-center rounded-full text-5xl font-bold border-4">
