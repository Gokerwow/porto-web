...
export default function BlurText({ children }: BlurProps) {
    ...
    return (
        <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} variants={container} initial="initial" animate="animate" className="absolute z-20 left-50 top-1/4">
