...
export const SplashScreen = ({ duration = 4.5, onAnimationComplete }: SplashScreenProps) => {
    ...
    return (
        ...
        >
            ...
            >
                <svg className="absolute inset-0 w-full h-full text-gray-500 animate-spin" viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="40" fill="transparent" stroke="currentColor" strokeWidth="2" strokeDasharray="5 10" 
 />
                </svg>

                <div className="absolute inset-0 flex items-center justify-center text-5xl text-gray-500">
