...
export default function BlurText({ children } : BlurProps) {
    ...
    return (
        <motion.div initial className="absolute z-20 left-50 top-1/4" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            <div className=''>{children.split("").map((l, i) => {
