...
export default function Navbar() {
    ...
    return (
        <motion.div initial={{ y:100, opacity:0 }} animate={{ y:0, opacity:1 }} transition={{ type:"tween" ease:'backOut', delay:1 }} className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
