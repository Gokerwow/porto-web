...
import { Calendar, Clock, Zap, Target, Code2 } from "lucide-react";
import Image from "next/image";
import { BackButton } from "@/components/backButton";
import { ExternalLinkComp } from "@/components/externalLink";
import { CldPlayer } from "@/components/cldPlayer";
...
export default async function ProjectPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const isVideo = !project.media?.includes('.png');
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-7">
                            ...
                            <div className="flex flex-wrap gap-6">
                                {project.github && (
                                    <ExternalLinkComp href={project.github} type="github"/>
                                )}
                                {(project.demo || project.liveUrl) && (
                                    <ExternalLinkComp href={project.demo || project.liveUrl || '#'} type="demo"/>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-5">
                            <div className="relative w-full h-full">
                                {isVideo ? (
                                    <CldPlayer media={project.media} type="page"/>
                                    
                                ) : (
                                    <div className="w-full h-96 rounded-lg shadow-2xl relative">
                                        <Image
                                            src={project.media}
                                            alt={project.title}
                                            fill
